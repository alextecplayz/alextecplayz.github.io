---
permalink: /collections/websites.html
postid: PA-250925-01
postid_alt: CollectionWebsites
title: "Collections: Websites and People"
description: "A collection of websites, posts, blog notes, and people that I recommend."
image_banner_link:
image_banner_alt:
type: page
lang: en
...
*Sorted in alphabetical order, any additional info, links to their website or social media as a fallback where possible*

Have any people, blog posts, or websites to recommend? Feel free to [tag me](https://techhub.social/@alextecplayz) in a post on Mastodon. This is a continuation of the /recommends page, but better.

## 0

- [3kliksphilip](https://www.youtube.com/@3kliksphilip), [2kliksphilip](https://www.youtube.com/@2kliksphilip), [kliksphilip](https://www.youtube.com/3kliksphilip) - Counter-Strike: Global Offensive, Counter-Strike 2, Source Engine, Source 2, Half-Life: Alyx, Source mapping, old guides, general gaming, photography and videography, Philip's story about developing his own games, developing his own CSGO maps, etc. All-round, equal parts entertaining and informative, I really recommend his channels. I keep looping his playlists regarding his mapping and game development journey when making my own stuff, it helps me concentrate. Also publishes music, has a CS:GO / CS2 music kit. In his latest [Klik empire analysis video](https://www.youtube.com/watch?v=pMV1R469EWI) he reveals a bunch of the imaginary shitstorm that has formed around him, and how he's made out to be this evil, sick, twisted person, how he's allegedly transphobic or whatever. **I'm on klik's side**, none of the content he has ever produced has been transphobic. Here's his quote from this video about his stance on trans people: "I don't give a damn what you identify as. I literally couldn't care less. It's as relevant to me as your religion or place of birth. It's just irrelevant when all I want to do is talk to you about upscaling and where I judge you on the quality of your character and how you treat me.". He doesn't really look into social politics or social issues, so he basically has close to no knowledge about certain topics, but he's made out to be the worst person on earth by presumably an amalgamation of frustrated moronic 'fans' that doxx him and send him death threats. What the fuck is wrong with some people?

## A

- [Absolute Terry Davis](https://www.youtube.com/@absoluteterrydavis/videos) - ignoring that Davis was a schizo whose racist remarks probably came from the severe mental illness he had at the time, it's fun to see how someone built a whole-ass operating system (TempleOS) and a programming language (HolyC) to be used in combination with Assembly to build TempleOS. Also works as background noise while you do other things. Davis is, by all accounts, a legend in the computing world.
- [Adam Something](https://www.youtube.com/@AdamSomething/videos) - satirical, funny, yet very informative videos about current topics regarding the Russian-Ukraine war, cryptobros, right-wing bullshit, alpha male bullshit, alt-right BS, debunking Elon Musk and other techbros' utter drivel, etc. For example, one video I really recommend at the moment is a video regarding [~2500 Russian propaganda books](https://www.youtube.com/watch?v=iCI6es9G0oo) where Stalin saves the day, spreading communism (ugh 🤮). These books seemed to have been overlooked, but they could be very important as to why many people in Russia still support the ongoing war. Wrote a nice little [thread on Mastodon](https://techhub.social/@alextecplayz/112933713909050467) about this exact thing after watching it. Really useful information.
...
- [Alan Fisher](https://www.youtube.com/@alanthefisher/videos) - known for his YouTube series, The Armchair Urbanist. If you like Not Just Bikes, you'll like this channel as well.
- [Alex Russell](https://infrequently.org/) - also known as Infrequently Noted. Has some interesting posts. I haven't yet read all of them, but I have read [11ty Hacks for Fun and Performance](https://infrequently.org/2025/10/11ty-hacks-for-fun-and-performance/), which provided me with another perspective on how people optimize their 11ty blogs.
...
- [Babish Culinary Universe](https://www.youtube.com/@babishculinaryuniverse/videos) - Also known as Cooking With Babish. Really good recipes, nowadays also does tierlists which I like, but I kind of wish they live-streamed cooking again, those streams were pretty interesting.
- [Boy Boy](https://www.youtube.com/@Boy_Boy/videos) - "making communist propaganda for idiots", but now really, I do like some of their investigations, such as the recent [Pine Gap](https://www.youtube.com/watch?v=XHMa-Ba-2Mo) video. Their views seem to be socialist, and this is seemingly confirmed by a stream by HassanAbi. I'd be a little disappointed if they turn out to be actually communist, but I'd still watch as long as the content is good.
- [Bright Sun Films](https://www.youtube.com/@BrightSunFilms/videos) - docummentaries about companies that have filed for bankruptcy, and occasionally exploring abandoned locations such as malls and stores.
- [Build The Lanes](https://www.youtube.com/@buildthelanes/videos) - a channel by [Steffen](https://www.youtube.com/@SteffenGoestoUkraine/videos) exploring the science of urban planning and transport, previously about the Netherlands and now about Ukraine, having moved there in June 2025. Steffen has also volunteered to join the Ukrainian Army to fight in the war against Russia, so posts and videos have become scarce.

## C

- [Cartoonshi](https://www.youtube.com/@Cartoonshi/videos) - yep, video and show reviews
- [Chad Chad](https://www.youtube.com/@thechadx2/videos) and her second channel, [Chad Chad Chad](https://www.youtube.com/@chadchadchad/videos) - sapphic commentary channel, her videos are light-hearted and fun
...
- [Crowbcat](https://www.youtube.com/@crowbcat/videos) - Highly edited, experimental game analyses, comparisons and compilations, such as [overpromise, sell, underdeliver Cyberpunk 2077](https://www.youtube.com/watch?v=omyoJ7onNrg), [Remember Halo](https://www.youtube.com/watch?v=nz3Ko0td45w), [Back 4 Blood proves Valve carried Left 4 Dead](https://www.youtube.com/watch?v=EdRLNUGmFC8) (as the B4B team had, at most, 3 or 4 ACTUAL former Valve/Turtle Rock Studios employees, so B4B isn't actually "from the people that made L4D", that's just a blatant misrepresentation), some painful console launches, Todd Howard (Bethesda)'s little lies, various supercuts of events such as E3, etc. Cool stuff, even if the videos are posted very rarely!
- [Cymaera](https://www.youtube.com/@heledron/videos) - Minecraft mod / framework developer. The latest video is about a [procedural galloping animation system](https://www.youtube.com/watch?v=r70xJytj0sw), based on a [procedural walking animation system](https://www.youtube.com/watch?v=Hc9x1e85L0w) unveiled in March 2024.

## D

- [Dean Ashford](https://www.youtube.com/@DeanAshford/videos) - Unreal Engine 4 and 5 tutorials. He stopped uploading a year ago (in 2023), however most, if not all tutorials still hold up well.
- [Defunctland](https://www.youtube.com/@Defunctland/videos) - all about the history of Disney parks, Disney park attractions and characters. Very interesting stuff!
- [Drew Gooden](https://www.youtube.com/@drewisgooden/videos) - somewhat mindless entertainment content, however he does make some more serious videos on topics such as [how AI is ruining the internet](https://www.youtube.com/watch?v=UShsgCOzER4), [how cars are getting dumber (and therefore, worse)](https://www.youtube.com/watch?v=_S7GU9lDpq8), or [how delivery apps fuck over everyone](https://www.youtube.com/watch?v=hsMujJYPagQ).

## E

- [Eddy Burback](https://www.youtube.com/@EddyBurback/videos) - in a similar fashion to Drew Gooden, however with fewer mindless content. Some of the 'best hits' are videos on [the truth about ghost kitchens](https://www.youtube.com/watch?v=KkIkymh5Ayg) and [the soulless, dystopian, shitty $3500 Apple Vision Pro](https://www.youtube.com/watch?v=kLMZPlIufA0).
- [elle](https://ellesho.me/page/website/) - I found this site through Octothorpes' documentation, if you enable JavaScript it has an interactive isometric pixel art room! You can tap on the room's floor to move elle around, you can click on specific objects such as the laptop, mailbox, the cat, you can even change elle's appearance to use a cat hoodie! tapping the balloon opens a screen which has a TUI map to explore other pages on her site, it's super nice.
- [Emma Thorne](https://www.youtube.com/@EmmaThorneVideos/videos) - videos that talk about social issues such as LGBTQ+ rights, religion and conspiracy theories mainly related to the UK, and the occasional movie or show review. Also had discussions with professors studying religion and other fellow atheist content creators.
...
- [Evan Edinger](https://www.youtube.com/@evan/videos) - American-British youtuber living in London, highlights the difference between urbanism in the US and UK, sometimes other parts of Europe such as Paris.
...
- [F1nn5terLIVE](https://www.youtube.com/@F1nn5terLIVE/videos) - of course I'm subscribed to F1nn on YouTube, why do you ask? He's so cute and pretty.
- [Folding Ideas](https://www.youtube.com/@FoldingIdeas/videos) - pretty cool docummentaries about stuff from Dan Olson, including [the problem with NFTs](https://www.youtube.com/watch?v=YQ_xWvX1n9g) and how NFT's are just the latest symbol of a much greater thing, the [metaverse](https://www.youtube.com/watch?v=EiZhdpLXZ8Q), pseudo-science and movie reviews. If you're not watching Folding Ideas, you're missing out. 
- [Forgejo](https://forgejo.org) // [Donate (LiberaPay)](https://liberapay.com/forgejo) - I'll self-host this someday, but until then, I could take it for a test drive on a Hetzner server.
- [FunkyFrogBait](https://www.youtube.com/@funkyfrogbait/videos) - similar to a react channel, with short, sometimes satirical, but more often than not informational videos on social issues and social media trends.

## G

- [GitLab](https://about.gitlab.com/) - It's fine. I don't really like the UI with a sidebar for GitLab, it doesn't work on desktop and it especially doesn't work on mobile, it's very clunky and slow on Firefox Android.
- [Godot Engine](https://godotengine.org), with their [YouTube channel](https://www.youtube.com/@GodotEngineOfficial/videos) where you can check out the yearly showreels, live streams and conferences.

## H

- [Highland Kall](https://www.youtube.com/@HighlandKall/videos) - trans gal that likes to draw, has a few short videos from time to time.

## I

- [Iceshrimp](https://iceshrimp.dev/iceshrimp/iceshrimp) // [Donate to the frontend dev](https://bunq.me/lilianhealthcarefund) - and Iceshrimp.NET, an alternative to Mastodon, Misskey, etc.
...
- [Immich](https://immich.app/) - Virtually identical to Google Photos, has incredibly similar UI and UX, and features, including self-hosted, hardware-accelerated ML for face recognition and smart search. I use this on my Raspberry Pi and it uses no more than 2GB at idle and even while under load, it doesn't go up by much. I personally consider it stable enough, as it can handle well my 185GB content (83K photos, 13K videos)
- [InsertNameHereGameDev](https://www.youtube.com/@InsertNameHereGameDev/videos) - Some Unreal Engine 4 / 5 tutorials, mostly related to vehicle NPC AI.

## J

- [j aubrey](https://www.youtube.com/@jaubrey/videos) - highly edited docummentaries (sometimes, multi-part docummentaries) about (in)famous people, mainly politicians and social media stars, such as a newly-released video on [JD Vance](https://www.youtube.com/watch?v=MvdJsl4owog), a multi-saga on [Peter Thiel](https://www.youtube.com/watch?v=ySoHSMI6RU8), [Jeffrey Epstein and DJT saga](https://www.youtube.com/watch?v=8R_9SZUNmhA), Musk, Vince McMahon, a saga on P Diddy, and so on.
...
- [Jeff Geerling](https://www.youtube.com/@JeffGeerling/videos) - Jeff the Pi guy, but also other tech, and experiments such as using Intel GPUs with a Raspberry Pi.
...
- [Juxtopposed](https://www.youtube.com/@juxtopposed/videos) - UI redesigns of popular platforms such as Steam, testing modern browser UIs, creating her first Linux UI theme, etc.

## K

- [KangFasho](https://www.youtube.com/@KangFasho/videos) - really honest, even if kinda angry and frustrated, reviews about games. None of that "Game is bad because WOKE" or whatever.

## L

- [LastWeekTonight](https://www.youtube.com/@LastWeekTonight/videos) - Last Week Tonight with John Oliver. Important political topics and social issues boiled down into half-funny, half-serious videos
- [Lean Rada](https://leanrada.com/) - an absolutely fantastic blog with so many smooth animations and transitions. You might've heard of Lean's website for the [CSS-only blurry image placeholders](https://leanrada.com/notes/css-only-lqip/) post he made last year in March. What a read that was!
- [Lusiogenic](https://www.youtube.com/@Lusiogenic/videos) - Physics-related Unreal Engine 4 tutorials. Stopped uploading videos in 2021, however he still seems to be active on [Twitter](https://x.com/Lusiogenic), resharing posts as recently as August 10, 2024.
...
- [Mastodon](https://github.com/mastodon/mastodon) // [Sponsor](https://sponsor.joinmastodon.org/) - the baseline for federated social media IMO.
- [Mastodon Glitch Edition](https://github.com/glitch-soc/mastodon/) - It has a couple big changes over Mastodon, mainly media improvements, post formatting, local-only posts, threaded mode, highlighting misleading links.
- [Matt Aspland](https://www.youtube.com/@MattAspland/videos) - Good Unreal Engine tutorials, especially if you're a newbie. Also hosts game jams from time to time.
- [münecat](https://www.youtube.com/c/m%C3%BCnecat/videos) - rare, but good investigations into pseudoscience, MLMs, scams, the 'manosphere', capitalism, and politics.
- [Mysk](https://www.youtube.com/@mysk/videos) - Independent security researchers. Also active on [Mastodon](https://mastodon.social/@mysk), they revealed that Signal still hasn't done anything regarding local encryption on the macOS Signal Desktop app, even if the issues were reported all the way back in 2015-2016. Signal has finally, allegedly, begun developing this feature following pressure from the community. Fucking finally. Mysk also revealed about how 2FA apps are [spying on you](https://techhub.social/deck/@alextecplayz/112723799806401183) - do NOT use Google Authenticator, Microsoft Authenticator, or Authy. All details are in the post I made, as linked here.
...
- [Not Just Bikes / Jason Slaughter](https://www.youtube.com/@NotJustBikes/videos) - Take the orange pill. Not Just Bikes focuses on urbanism isusues in primarily the US, Canada and the Netherlands, but has some videos on other countries such as Japan as well, on topics such as cycling, car-free infrastructure, public transport, walkability and debunking some lies here and there. Did/does some livestreams at times, very irregularly, when cycling.
...
- [Ordinary Things](https://www.youtube.com/@OrdinaryThings/videos) - not quite an ordinary channel. Has great docummentaries and yearly recaps.
...
- [penguinz0](https://www.youtube.com/@penguinz0/videos) - Charlie MoistCr1TiKaL. Nothing more needs to be added, he's one of the YouTube OGs.
...
- [PrismaticaDev](https://www.youtube.com/@PrismaticaDev/videos) - UE4/5 tutorials and live streams, good stuff!
...
- [Seredias](https://www.youtube.com/@Seredias./videos) - UE5 tutorials, mostly about driving and some NPC AI
- [shirashiraonthewall](https://www.youtube.com/@shirashiraonthewall/videos) and her second channel, [shira2xonthewall](https://www.youtube.com/@shirax2onthewall/videos) - similar to RayLikeSunshine, she makes short funny commentary videos similar to react channels, more on social issues and social media trends on TikTok
...
- [SomeOrdinaryGamers](https://www.youtube.com/@SomeOrdinaryGamers/videos) - I don't think I need to explain Mutahar's channel? Windows, Loonix (Linux), Security, privacy, gaming and politics commentaries similar in style to penguinz0.
- [Stack Wallet](https://stackwallet.com/) // [Donate (StackWallet.com)](https://stackwallet.com/donate.html) - Open-source cryptocurrency wallet that supports many cryptocurrencies, and you control your private keys. Encrypted backups and an in-app exchange are available as well. **Would recommend** if you need to use or hoard cryptocurrency. I stopped using it and Ultimate Wallet because crypto never took off, and even if I were to say, have people donate to me via BTC and ETH, trying to convert small, meaningless amounts of crypto into actual currency is more expensive than just hoarding it in a wallet.
- [Starea Nației](https://www.youtube.com/@StareaNatiei/videos) *(State of the Nation)* - incredible independent, long-running, weekly web show, weekly livestreams on Monday and podcast that talks about current things that are good and bad with Romania, has podcasts, and sometimes invites some people for interviews, has a [website](https://stareanatiei.ro/) and you can [donate](https://stareanatiei.ro/sustine/) to the project. They've built a theater and cafe in Ploiești, from independent donations. The show's host and 'owner', Dragoș Pătraru, has spent most of the money he earned over two decades, and even borrowed some from banks, so that he could invest almost a million EUR into this project. They're not sponsored by any company or politician. Primarily left-wing leaning from the politics side, LGBTQ+ friendly, with a somewhat nuanced take on capitalism that leans towards socialist democracy. I love watching this. Some premieres have auto-generated Romanian captions, so it's possible you could translate them to your language if you want to watch the show. It's REALLY helpful if you want to know what happens in Romania, on a day-to-day basis. Highlights corruption, hypocrisy and lies by the Romanian government, and its institutions.
- [STRANGE ÆONS](https://www.youtube.com/@STRANGEONS/videos) - (*strange aeons*), videos on Tumblr stuff from a lesbian and her girlfriend's occasional appearance to join in on the *fun findings* from that platform. And two cute cats! I'm not at all a fan of Tumblr, I don't really understand it, so STRANGE AEONS is my only connection to that side of the internet.

## T

- [Tantacrul](https://www.youtube.com/@Tantacrul/videos) - [Martin Keary](https://www.martinkeary.com/), the head of software at Muse, and videos on how Audacity is being designed and overhauled, various videos about critiques of music software, , and a video on how he assembled a team to create MuseScore 4.
- [TBH Podcast](https://www.youtube.com/@TBHpodcast/videos) - occasional podcast featuring Dolan Dark, Pyrocynical and Colossal is Crazy.
...
- [underscore](https://www.youtube.com/@underscore00/videos) - unreal engine tutorials, great stuff like the LCD screen, nav mesh basics, footstep sounds and more

## V

- [Valeriu Nicolae](https://www.youtube.com/@valeriuciolannicolae-s8h/videos) - Romanian political commentaries and live streams every month, also makes a few appearances in live streams and shows at Starea Nației. Runs a Romanian NGO [Casa Bună Association](https://asociatiacasabuna.ro/) with quite a few big companies and Romanian subsidiaries of companies as occasional sponsors, such as eMAG, Microsoft Romania, JYSK, IKEA, Lensa Romania, Regina Maria (private health network), UniCredit, Kaufland Romania and the Humanitas Group.
...
- [Vercidium](https://www.youtube.com/@Vercidium/videos) - spent 7 years to make a game, made a few videos about it and then some about game / game engine optimization, got his millions of views and phased out of existence. I question *some* of his optimizations, but since I'm no longer making my own game engine, I won't bother testing his claims.
...
- [Well There's Your Problem Podcast](https://www.youtube.com/@wtyppod/videos) - podcasts about engineering and some urbanism
- [Whitelight](https://www.youtube.com/@Whitelight/videos) - fantastic, lengthy reviews of games

## X

## Y

- [Yet Another Urbanist](https://www.youtube.com/@YetAnotherUrbanist/videos) - yep, yet another urbanist channel I'm subscribed to, I wonder why... 🤔. Videos about US-centric urbanism and how it can be improved.
...
...and the other side. People, projects, websites that I don't recommend. Also sorted alphabetically for your convenience.
...
- [David Neinmeier Hansson](https://world.hey.com/dhh) - fascist-aligned racist, anti-woke, claims that ADHD isn't real. I wrote my thoughts in large in my [Framework stance post](https://alextecplayz.com/posts/2025-10-12-AI-Framework-stance.html#david-neinmeier-hansson), but the short version is that he whined and complained about an open letter (Plan Vert) asking Ruby Central to cut ties with him, had his techbro rich white guys, including the founder of Shopify Tobi Lutke, the lead developer of the Ladybird browser project Andreas Kling, the creator of TailwindCSS and the creator of the Laravel PHP framework among others, chime in to support DHH against this letter which amounted to nothing. DHH also published a post about how the UK has changed, it's no longer mainly white people but 'immigrants' (so, calling non-White citizens born in the UK 'immigrants'), and then talked about how a Tommy Robinson rally where British flags were flying high made him feel proud - ignoring altogether the historic fact that Tommy Robinson is explicitly a fascist - and then going on and on about right-wing talking points like Pakistani rape gangs or whatever. DHH did not call out any of the talking points in his post or people such as Tommy for being fascist or fascist-aligned. So, if DHH walks and talks like a fascist, the logical conclusion is that he most likely is a fascist as well.
- Drew DeVault - [defends pedophiles, watches loli/shota content](https://dmpwn.info/), all while having penned [the Stallman Report](https://stallman-report.org/), ironically enough.
...
- [Framework](https://frame.work) - [I'm on the fence](https://alextecplayz.com/posts/2025-10-12-AI-Framework-stance.html) about possibly buying one or two Framework laptops (*someday, I'm not THAT rich to even afford ONE!*). They're the only truly modular laptop manufacturer, and it's sad to see them trying to go for a 'big tent' approach by literally sponsoring Omarchy, which isn't even a distro but a simple, naive script that converts in place a Linux Arch installation, led by none other than David Neinmeier Hansson, a fascist-aligned rich white guy that has been complaining about 'Wokeness' and immigrants, and how ADHD isn't real and whatnot. But more details on DHH [above, at the letter D](#d-1). Framework has also sponsored Hyprland, which had a history of edgyness and right-wing support. Hyprland's lead dev at one point wrote on his blog that he doesn't care if *literally* Adolf Hitler joined their Discord server, they'd be fine with it as long as he wouldn't talk about gassing the Jews - although the Hyprland community has improved since then, it was still questionable at the time. I wrote more thoughts in my own post linked at the start of this paragraph.
...
- Richard Stallman - not just because he's a creep and [a normalizer of sexual misconduct and sexual abuse](https://stallman-report.org/), but there's enough of a cult around him that you should stay away from both RMS and RMS bootlickers.
