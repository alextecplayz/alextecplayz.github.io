...
# AlexTECPlayz
[ *full name redacted, request confidential information at [requests.alextecplayz@vantainteractive.com](mailto:requests.alextecplayz@vantainteractive.com)*]

CV also available in [text form](https://alextecplayz.com/cv.txt), [Markdown form (*which you're currently viewing*)](https://alextecplayz.com/cv) and [PDF form](https://alextecplayz.com/cv.pdf)*, although note that the PDF version may easily become outdated. If you notice that it's outdated, let me know via Fedi or e-mail and I'll update it ASAP ^v^.*

## Contact details
E-mail: [ *redacted, request confidential information at [requests.alextecplayz@vantainteractive.com](mailto:requests.alextecplayz@vantainteractive.com)* ]\
Phone number: +40 [ *redacted, request confidential information at [requests.alextecplayz@vantainteractive.com](mailto:requests.alextecplayz@vantainteractive.com)* ]\
...
**At this time, the only work that I can accept is via a Romanian company, and a Romanian work contract. I do NOT yet have a legal entity such as an LLC (Romanian SRL) in order to perform freelance work, or to be contracted by companies that do not have a physical office within Romania, or that comply with local laws.**

## Skills and competencies

- Software development in HTML, CSS, JS, and C++
- Game development in C++ (incl. visual development languages such as Blueprint in Unreal Engine), using Unreal Engine 4, 5, and Godot 4, using GDscript and C++
...
I entered data such as the results of the laboratory analyses in Excel and Word, using the hospital's defined standards for drafting. Furthermore, I helped in rewriting and reorganising the General Management System used to achieve RENAR standards, as well as drafting proposed changes during the inspection.
...
The activity consisted of using 3 main programs — Microsoft Excel, and two internal programs, one used for entering pickup orders, sending/placing them (changing the order's status) to the couriers' PDAs, changing statuses, checking the pickup address, etc.; and a program for checking expeditions' statuses in the warehouse (e.g., which zone of the local warehouse, shelf), as well as generating Excel and in-program reports on statuses of courier shipments, and the streets they operate on, daily, calling or responding to courier phone calls regarding certain expeditions.
...
The working hours were between 8 AM and 5 PM, with regular shifts that lasted up to 6 PM to ensure that all orders were picked up by couriers, as well as working at times on Saturdays between 8 AM and 2 PM.

---

*Cluj-Napoca — Customer Reception Department (May 27-June 27)*

Following an internal restructuring of departments under the recently-changed leadership, I was moved to the customer reception department. Here, I had direct contact with the customers, creating shipments to other FAN offices and addresses within the country, as well as in other countries.

Furthermore, it included checking the status of packages by tracking AWB numbers using the previously-mentioned internal program that was used for checking expeditions' statuses in the warehouse and în the field; handing over packages and collecting transportation or remuneration by cash or card; as well as handling customer disputes regarding orders being automatically sent to FANboxes by certain expediter companies, complaints, and other procedures.

I decided that my final day with FAN Courier Cluj-Napoca would be June 27, as the ‘honeymoon phase’ of the new leadership was over, which resulted în other couriers and personnel leaving or switching to a different branch, as the franchisor introduced some controversial changes to day-to-day operations which I deemed were unreasonable and unachievable.

The working hours were from 9 AM to 5 PM or from 11 AM to 7:20 PM, as well as working at times on Saturdays between 9 AM and 2 PM.

---

**October 2025 - December 2025 - Seasonal Customer Service Associate - HKR**\
*Remote (from home) - Customer Service Department (October 27 - December 31 2025) - Full-time (8 hours), 2800 RON / €558 / $640 (net pay) salary per month + additional bonuses for legal holidays, chat and weekend hours + additional bonus (net) upon completion of the contract as I have reached the performance requirements*

The activity consisted of providing helpful information and assisting customers reaching out with issues related to the delivery of their items (e.g., order is late, order tracking is missing or has not been updated), damage and inconsistencies to said items, refunds, replacements and exchanges, modifying orders, or requesting general information such as payment and delivery methods. This was done through the Zendesk platform both via e-mail (tickets/issues) and chat.

Communication with the seasonal team I was assigned to and the US-based partner happened over Slack and video meetings over Google Meet.

The working hours were from 9 AM to 6 PM (morning shift) or from 3 PM to 12 AM (night shift), as well as working at times în the weekend.

## Other notable work

- Developing games and plugins in the open-source game engine Godot 4, namely the `Sapphire` plugin and engine plugin toolkits that were previously C++ additions to the engine under a private hard fork. Sapphire is used by all of my projects, and new features are added regularly. Such features include a‘Material You Expressive’ UI framework re-creation for a future bookmark manager app, support for third-party rendering debuggers such as RenderDoc and NVIDIA Nsight, a game console and a template/pre-built asset and code manager, as Godot lacks such a tool. Before June 2025, Sapphire was a hard fork of Godot, and before February 2025, it was an original from-the-ground-up C++-based game engine (also named Sapphire) that was abandoned due to time constraints following my time working at Fan Courier.
...
- Continuing development of personal projects previously mentioned, such as Sapphire, PRISONIA, and my website projects for my personal brand (*AlexTECPlayz*) and “professional” brand (*Vanta Interactive*), as well as trying out new things and figuring out new ways to improve performance for games.
