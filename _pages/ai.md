...
# Nothing I write is AI-generated.
...
I recognize the possibilities of this tech, I did play around with [Suno AI](https://suno.com/home) for a day back at the beginning of 2025 to see what's all the fuss about, and I wasn't impressed in the slightest. It's cool that we've managed to create large language models that can spit out human-adjacent text that may even seem convincing at times, but I'm wholly against it in the current way it's still being hyped, as part of the 'AI' bubble that I can't help but hope that it pops any day now, because it's taken away accessible RAM and HDDs from consumers. I advocate for ethical generative tool use, and I can't help but hope that some open-source LLM trained on only open, properly-licensed data will someday be available for general use.

[KL3M](https://aleainstitute.ai/work/kl3m-data-project/) is an AI model family that claims to use 'copyright-clean' training resources, but it's mainly intended for some very basic legal text (*and any response from KL3M should not be taken as legal advice*), and while I would love to try it out, I couldn't convert its [safetensors model](https://huggingface.co/alea-institute/kl3m-003-1.7b) to .gguf so that I could run it through Alpaca.

There is also the [IBM Granite](https://www.ibm.com/granite) family of LLM models, which seems to be the most transparent regarding its training data, compared to basically every other AI company measured on [Stanford's Foundation Model Transparency Index](https://crfm.stanford.edu/fmti/December-2025/index.html).

**LLMs are NOT intelligent, they have no conscience, thoughts, rationality, they are not human, or even human-adjacent. LLMs do not 'understand', have no concept of thought or a mind. Anyone that's telling you otherwise is a moron that has no idea how LLMs operate, and the underlying tech that is used to power LLMs. Fuck those people, do not listen to them. We perceive LLMs generating 'incorrect' stuff as 'hallucination', as this is the human comprehension, we try to antropomorphize such behaviours so they seem 'human' or 'human'-esque, 'human enough', etc.**
